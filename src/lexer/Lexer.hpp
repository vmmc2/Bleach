...
class Lexer{
  ...
  public:
     ...
     *
     * @param sourceCode: The source code of the Bleach file intended to be interpreted.
     *
    ...
    **/
     ...
     * by this method.
     * 
     * @return The list of tokens generated by the lexical analysis executed by the lexer.
    **/
